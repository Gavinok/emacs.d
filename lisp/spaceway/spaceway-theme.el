...
(let ((class '((class color) (min-colors 89)))
      ...
      (custom-theme-set-faces
       ...
       `(org-checkbox ((,class (:foreground ,spaceway-green-0))))
       ...
       `(org-level-8 ((,class (:foreground ,spaceway-green-0))))
